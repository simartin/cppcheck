...
**Message**: Same iterator is used with different containers 'l1' and 'l2'.<br/>
...
void foo() {
    ...
    l2.insert(it, 0); // <- iterators1: 'it' belongs to l1, not l2
}
```
...
- [mismatchingContainerIterator.md](mismatchingContainerIterator.md) - the same code shape is also
  caught by this related, differently-worded check; both messages can appear together on the same
  line.
