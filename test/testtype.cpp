    ...
    void checkTooBigShift_Unix32() {
        ...
        // and signed types having already a size of 4 bytes
        {
            ...
            for (const std::string& type : types) {
                ...
                check(type + " foo(" + type + " x) { return x << 30; }\n", dinit(CheckOptions, $.settings = &settings));
                ASSERT_EQUALS("", errout_str());

                // c++14
                check(type + " foo(" + type + " x) { return x << 31; }\n", dinit(CheckOptions, $.settings = &settings, $.standard = Standards::CPP14));
        ...
        {
            // unsigned long long
            check("unsigned long long foo(unsigned long long x) { return x << 64; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting 64-bit value by 64 bits is undefined behaviour\n", errout_str());
            check("unsigned long long f(int x) { return (x = (unsigned long long)x << 64); }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting 64-bit value by 64 bits is undefined behaviour\n", errout_str());
            check("unsigned long long f(unsigned long long x) { return x << 63; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("", errout_str());
            // [signed] long long
            check("long long foo(long long x) { return x << 64; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting 64-bit value by 64 bits is undefined behaviour\n", errout_str());
            check("long long f(int x) { return (x = (long long)x << 64); }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting 64-bit value by 64 bits is undefined behaviour\n", errout_str());
            check("long long f(long long x) { return x << 63; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting signed 64-bit value by 63 bits is undefined behaviour\n", errout_str());
            check("long long f(long long x) { return x << 62; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("", errout_str());
            // signed long long
            check("signed long long foo(signed long long x) { return x << 64; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting 64-bit value by 64 bits is undefined behaviour\n", errout_str());
            check("signed long long f(long long x) { return (x = (signed long long)x << 64); }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting 64-bit value by 64 bits is undefined behaviour\n", errout_str());
            check("signed long long f(signed long long x) { return x << 63; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("[test.cpp:1]: (error) Shifting signed 64-bit value by 63 bits is undefined behaviour\n", errout_str());
            check("signed long long f(signed long long x) { return x << 62; }\n",dinit(CheckOptions, $.settings = &settings));
            ASSERT_EQUALS("", errout_str());
